...
export default function SyncStatus(){
  ...
  const resolve=async(id:string,resolution:'keep_local'|'accept_server'|'dismiss')=>{setBusy(true);try{await resolveSyncConflict(id,resolution);if(resolution!=='dismiss')await syncPendingChanges();}finally{setBusy(false);await refresh();}};
