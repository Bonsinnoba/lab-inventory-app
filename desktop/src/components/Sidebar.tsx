...
export default function Sidebar({ user, onLogout }: SidebarProps) {
  ...
  const renderLink = (item: { icon?: typeof User; label: string; path: string }, compact = false) => {
    ...
    const tooltipLabel = collapsed ? item.label : '';
