...
import { transactionPermission } from './middleware/transaction-permissions.js';
...
app.use('/api/transactions', authenticateToken, transactionPermission, transactionsRouter);
